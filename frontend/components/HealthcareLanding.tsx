...
import { HeartPulse, DockIcon , DollarSignIcon , CloudDownloadIcon , Shield, Activity, Users, Star, ArrowRight, CheckCircle2, Phone, Calendar, Brain, Stethoscope, Globe, Award, Sparkles } from 'lucide-react';
...
const FloatingIcons: React.FC = () => {
  const icons = [HeartPulse, Brain, Shield, Activity, Stethoscope ,  DockIcon , DollarSignIcon , CloudDownloadIcon ,  DockIcon , DollarSignIcon , CloudDownloadIcon];
        ...
        >
          ...
          <motion.div style={{ opacity }} className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              />
                <Badge className="mb-4 px-4 py-2 bg-gradient-to-r from-teal-100 to-blue-100 text-teal-800 hover:from-teal-200 hover:to-blue-200 transition-all duration-300">
